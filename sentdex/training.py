...
# from keras import Dense, Dropout, Activation, Flatten
# from keras import Conv1D, MaxPooling1D, BatchNormalization
...
reshape = (-1, 16, 60) # what is this?

def create_data(starting_dir="data"):
    training_data = {} # empty dictionary
...
traindata = create_data(starting_dir="/Users/rithvikpraveenkumar/OpenBCI Project/sentdex/")
train_X = []
train_y = []
...
testdata = create_data(starting_dir="/Users/rithvikpraveenkumar/OpenBCI Project/sentdex/")
test_X = []
test_y = []
for X, y in testdata:
    test_X.append(X)
...
model.add(layers.Conv1D(64, (3), input_shape=train_X.shape[1:]))
